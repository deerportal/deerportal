...
public:
    ...
    std::string generateCardEffectText(const std::string& cardType, int playerNumber, int targetPlayer);
    ...
    std::string formatPlayerAction(const std::string& action, int playerNumber, int targetPlayer = -1);
...
private:
    ...
    std::string buildTargetedNotification(const std::string& cardType, int playerNumber, int targetPlayer);
