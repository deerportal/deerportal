...
public:
     ...
     */
    void showCardNotification(const std::string& cardType, int playerNumber, int targetPlayer = -1, int cardPileNumber = -1);
...
private:
     ...
     */
    void setupNotification(const std::string& text, int playerNumber, int targetPlayer, int cardPileNumber);
