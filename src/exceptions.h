...
public:
  GameException(std::string_view msg, std::string_view ctx = "") : message(msg), context(ctx) {}
...
public:
  SystemResourceException(ResourceType t, std::string_view msg) : GameException(msg), type(t) {}
